    ...
    if int(allscores) != 0:
        rating_tts_only = random.choice(
            [f'Ты набрал {decl_scores(sessionscore)} за игру и {decl_scores(allscores)} за всё время.\n',
             ...
             f'Весьма недурно! -  Ты набрал {decl_scores(sessionscore)} за игру, а всего {decl_scores(allscores)}\n.'
             ])

        rating_text = random.choice(['Это весьма хорошо.Продолжим покорять вершины?',
                                     'Очень неплохо! Предлагаю не останавливаться на достигнутом. Продолжим игру?',
                                     'Уверенна, что ты можешь больше. Продолжаем?',
                                     'Очень неплохо! Продолжим покорять вершины?',
        ...
        rating_text = random.choice(['Не густо. Начнём покорять вершины?',
                                     ...
                                     'Уверенна, что ты можешь на б+ольше. Продолжим игру, чтоб это исправить?',
                                     ])
